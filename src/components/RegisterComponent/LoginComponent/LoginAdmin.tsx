                ...
                <form onSubmit={loginForm} className="mt-8 space-y-6">
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <input 
                                type="email" 
                                required 
                                className="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl bg-slate-50 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 sm:text-sm transition-all" 
                    ...
                    <div className="pt-4 flex items-center justify-between border-t border-gray-100">
                        <div className="text-sm">
                            <Link to="/signUpAdmin" className="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">
                                Create Account
                            </Link>
                        </div>
                        <div className="text-sm">
                            <Link to="/loginEmployee" className="font-semibold text-slate-500 hover:text-slate-800 transition-colors">
